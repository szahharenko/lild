...
const Rules: React.FC<Props> = ({ rulesToggle, isOver }) => {
  return (
    <div className='rules-container'>
      <span className="close-button" onClick={ () => rulesToggle() }>×</span>
      { isOver ?
        <>
          <h2>Jah, soovin tellida LIDLi uudiskirja,<br/> mida levitab Lidl Eesti.</h2>
          <p>Personaliseeritud uudiskirja saajaks registreerudes nõustun sellega, et luuakse personaliseeritud kasutajaprofiil, mis võimaldab reklaampakkumisi ja veebilehtede sisu minu isiklikele huvidele paremini kohaldada. Rohkem teavet isikuandmete kaitse kohta.</p>
          <p>Uudiskirja tellimusest saad alati loobuda, kui klõpsad tellimusest loobumise linki, mille leiad uudiskirja lõpust.</p>
        </>
        :
        <>
