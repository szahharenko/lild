...
const SHARE_QUOTE =
  isRevealed ?
    'Lidl on avatud juba 3. märtsist! Tule mängi kampaaniamängu ja osale auhinnaloosis! Loosime välja 2500 taaskasutatavat poekotti koos Lidli värskuse kataloogi ja šokolaadiga.'
  :
    'Midagi suurt on kohe-kohe tulekul! Seniks tule mängi ja osale auhinnaloosis! Loosime välja 2500 taaskasutatavat poekotti koos värskuse kataloogi ja šokolaadiga.';
...
const RegSuccess: React.FC<Props> = ({currentUser}) => {
  ...
  return (
    <div className='result'>
      { isRevealed ?
        <h1 className='caps'>Oled liitunud <br/>Lidli uudiskirjaga.</h1>
        :
      ...
      <h2 className='caps'>Aitäh, et osalesid<br/> { isRevealed && 'Lidli'} värskuse loosis!</h2>
    </div>
  );
}
