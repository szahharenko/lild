...
const RegSuccess: React.FC<Props> = ({currentUser}) => {
  ...
  return (
    <div className='result'>
      <h1 className='caps'>Oled liitunud<br/>uudiskirjaga! {currentUser}</h1>
      <p><strong>Pssst..!</strong><br/>Jagades seda mängu, suurendad enda võiduvõimalusi.</p>
      <FacebookShareButton onClick={addExtraLike} url={"https://www.imagine.ee/"} quote={"OLED LIITUNUD UUDISKIRJAGA!"} className="Fb">
